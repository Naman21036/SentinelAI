...
from SentinelAI.entity.config_entity import DataTransformationConfig
from SentinelAI.entity.artifact_entity import DataIngestionArtifacts, DataTransformationArtifacts
